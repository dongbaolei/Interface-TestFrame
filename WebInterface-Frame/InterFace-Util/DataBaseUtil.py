...
if __name__ == '__main__':
    ...
    # cc = mydb.executeSQL("update ca_app_info set STATUS=32 where APP_CODE='L1712221000100102007'")
    # cc = mydb.executeSQL("select STATUS from ca_app_info where APP_CODE='L1712221000100102007'")
