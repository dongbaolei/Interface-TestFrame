...
class Appr_AppInfopage(unittest.TestCase):
    def setUp(self):
        self.jira = JiraUtil.JiraUtil()
        pass

    def test_A_right_appinfopage(self):
        '''单个审批记录-输入正确参数'''
        ...
        httpconf.set_url(params[11][2])
        httpconf.set_headers(params[11][3])
        httpconf.set_data(params[11][4])
